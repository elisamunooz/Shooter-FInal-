...
class Game {
     ...
     */
    constructor () {
        this.score = 0; // Atributo para la puntuación inicial
    ...
    collide(entity) {
        if (entity instanceof Shot) {
          ...
          this.game.updateScore(); // Actualizar la puntuación en pantalla
          this.die(); // Lógica para eliminar al oponente
        }
      }
    ...
    endGame() {
        if (this.player.lives > 0) {
          document.body.style.backgroundImage = "url('assets/you_win.png')";
        } else {
          document.body.style.backgroundImage = "url('assets/game_over.png')";
        }
      }
...
removeOpponent() {    
    ...
    this.opponent = new Boss(100, 100, this); // Crear jefe final
    }
  }
}  
